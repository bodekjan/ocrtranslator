...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uyType=Typeface.createFromAsset(context.getAssets(), "fonts/ALKATIP.TTF");
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NiceSpinner);
        ...
        textColor = getResources().getColor(R.color.colorHeader);
